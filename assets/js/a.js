...
(function() {
  ...
  window.add_multimeasure = function() {
    var func;
    func = function(arg) {
      var x1, x2, y1, y2, _ref, _ref1;
      _ref = arg[0], x1 = _ref[0], y1 = _ref[1];
      _ref1 = arg[1], x2 = _ref1[0], y2 = _ref1[1];
      if (y1 === y2) {
        return QC.add(new Qcircuit_multimeasure(y1, x1, x2, $('#gate').val()));
      }
    };
    return Q.bind(func, 2);
  };

  window.add_multimeasureD = function() {
    var func;
    func = function(arg) {
      var x1, x2, y1, y2, _ref, _ref1;
      _ref = arg[0], x1 = _ref[0], y1 = _ref[1];
      _ref1 = arg[1], x2 = _ref1[0], y2 = _ref1[1];
      if (y1 === y2) {
        return QC.add(new Qcircuit_multimeasureD(y1, x1, x2, $('#gate').val()));
      }
    };
    return Q.bind(func, 2);
  };
