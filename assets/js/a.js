...
(function() {
  var Axis, ECcnt, ECs, Q, QC, QcircuitGrid, Qcircuit_black_dot, Qcircuit_component, Qcircuit_gate, Qcircuit_label, Qcircuit_line, Qcircuit_meter, Qcircuit_multigate, Qcircuit_qswap, Qcircuit_target, Qcircuit_white_dot, Qcircuit_wire, QueueEvent, X, Y, center, click_event, clog, cols, dashed_box, draw, drawer, get_cur_rel_pos, insert_tab, locate_mouse, mk_table, rows, sz_cfg;
  ...
  Qcircuit_meter = (function() {
    ...
    Qcircuit_meter.prototype.draw = function(svg) {
      ...
      this.dom = svg.group();
      _ref = center(this.x, this.y), xc = _ref[0], yc = _ref[1];
      svg.image("assets/img/meter.png", 40, 32).addTo(this.dom).move(yc - 20, xc - 16);
      if (!this.tab) {
